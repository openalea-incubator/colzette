...
from openalea.colzette.scene import create_mixture_scene
...
Type_simul = "intercrop_vigo" # type of Total Leaf Area (TLA) curves : monocrop_aviso, monocrop_vigo, monocrop_faba, intercrop_aviso_RRF, intercrop_faba_aviso_RRF, intercrop_vigo, intercrop_faba_vigo
...
if Type_simul == "intercrop_aviso_RRF":
    ...
    print("Type_simul should be intercrop_aviso_RRF (default) or intercrop_vigo, other options are not supported")
    Type_rape = "intercrop_aviso_RRF"
